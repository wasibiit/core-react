        ...
        <Grid container spacing={8}>
            ...
            <Card>
              <CardContent>
                <Grid container spacing={24}>
                  <Grid item xs={7}>
                    <Typography variant="title" gutterBottom>Your <b>Name</b></Typography>
                    <Typography variant="caption" gutterBottom>someone@gmail.com</Typography>
          ...
          <Grid item xs={12} sm={12} md={6} lg={7}>
            <Card className="mb-xs">
              <form>
                <textarea placeholder="What's on your mind" rows="3" className={classes.postInput}></textarea>
              </form>
              <Divider />
              <CardActions>
